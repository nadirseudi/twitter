    ...
    <div class = "flex">
        ...
        <div class = "w-4/5">
            <div class = "flex ml-6 mt-20 justify-between">
                <img src = "<?php echo $_SESSION['picture']?>" alt = "logo de <?php echo $at_username?>" class = "w-24 h-24 rounded-full">
                <button type = "button" name = "edit" id = "edit" class = "border-blue-600 rounded-full border pr-2 pl-2 m-10 text-blue-600"> Editer </button>
            </div>
            <div class = "text-white mt-8 ml-6 mb-8">
                ...
                <a href = "followers_following.php" class="text-white my-5"> Abonnements : <?php echo $followings?> &emsp; Abonnés : <?php echo $followers?> </a>
            </div>
            ...
            <div class = "flex justify-center">
                <button type = "submit" name = "log_out" id = "log_out"> Déconnexion </button>
            </div>
        </div>
    </div>
